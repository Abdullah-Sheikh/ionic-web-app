...
const viewerConfig = {
    embedMode: "LIGHT_BOX", defaultViewMode: "FIT_WIDTH", showDownloadPDF: false,
			showPrintPDF: false
};
...
function previewFile()
{
    ...
    var adobeDCView = new AdobeDC.View({
        ...
        clientId: "41f4cd435805464db3345a63182e6b6a"
    });
    ...
    adobeDCView.previewFile({
        ...
        content: {
            ...
            location: {
                url: "https://www.jasonactual.com/THR.pdf",
                /*
...
function previewFile1 ()
{
    ...
    adobeDCView.previewFile({
        ...
        content: {
            /* Location of file where it is hosted */
            location: {
                url: "https://www.jasonactual.com/Resume.pdf",
                /*
                If the file URL requires some additional headers, then it can be passed as follows:-
                header: [
                    {
...
;(function ($) {
  ...
  $(document).on("ready", function () {
    ...
    body.magnificPopup({
      ...
      iframe: {
        markup: '<div class="mfp-iframe-scaler">' + '<div class="mfp-close"></div>' + '<iframe class="mfp-iframe" frameborder="0" allowfullscreen></iframe>' + '<div class="mfp-title mfp-bottom-iframe-title"></div>' + "</div>", // HTML markup of popup, `mfp-close` will be replaced by the close button
