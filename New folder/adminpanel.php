  ...
  <!-- General info section end -->
   ...
   <div class="row">
     <div class="col-md-6">
       ...
       <div class="card_Design">
       <div class="card-body">
         <h5 >Cases in Proviences</h5>
         <hr/>
       <span style="color:#CC0404"><b><div style="font-size: 25px;"> </b>
       	<?php get_patient_count_prov ();?></div></span>
       		<p>Maximum cases in Provience :<span style="color:#CC0404"><b> <?php get_max_patient_prov (); ?></b></span></p>
           <p>Minimum cases in Provience :  <span style="color:#005D66"><b> <?php get_min_patient_prov (); ?></b></span></p>
