      ...
      <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <li>
                    <a href="#homeSubmenu4" data-toggle="collapse" aria-expanded="false" >   <i class="fa fa-info-circle" style="margin-right:5px;" ></i>Doctors</a>
                    <ul class="collapse list-unstyled" id="homeSubmenu4">
                        <li>
                            <a href="adddoctors.php"><i class="fa fa-plus-square" aria-hidden="true" style="margin-right:5px;"></i>Add</a>
                        </li>
                        <li>
                            <a href="viewdoctors.php"><i class="fa fa-search-plus" aria-hidden="true" style="margin-right:5px;"></i>View and Search</a>
                        </li>
                        <li>
                            <a href="viewdoctors.php"><i class="fa fa-pencil" aria-hidden="true" style="margin-right:5px;"></i>Update</a>
                        </li>
                        <li>
                            <a href="logpatients.php"> <i class="fa fa-history" aria-hidden="true" style="margin-right:5px;"></i> logs</a>
                        </li>
